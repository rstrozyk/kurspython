...
percentSorted = percent.copy()
percentSorted.sort()
print(percentSorted)

print(statistics.median_high(percentSorted))
print(statistics.median_low(percentSorted))
mediana = [statistics.median_high(percentSorted),statistics.median_low(percentSorted)]
print(mediana)
